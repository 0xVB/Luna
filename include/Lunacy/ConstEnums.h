...
enum PickupMotion
{
    PICKUP_MOTION_FROM_SKY = 0,
    PICKUP_MOTION_FROM_SKY_SLOW = 1,
    PICKUP_MOTION_FROM_PLANT = 2,
    PICKUP_MOTION_COIN = 3,
    PICKUP_MOTION_LAWNMOWER_COIN = 4,
    PICKUP_MOTION_FROM_PRESENT = 5,
    PICKUP_MOTION_FROM_BOSS = 6
};
enum PickupType
{
    PICKUP_NONE,
