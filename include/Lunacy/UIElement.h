...
#pragma region Fields
	PopList<UIElement*> mChildren;
	UIRoot* mRoot;
	UIContainer* mParent;
	bool mUpdateIteratorModified;
	int mIteratorPad;
	std::list<UIElement*>::iterator mUpdateIterator;
	unsigned long mLastWMUpdateCount;
	int mUpdateCnt;
	bool mDirty;
	IRect mBounds;
	bool mClipChildren;
	PopFlags mUIFlagsMod;
	int mPriority;
	int mZIndex;
#pragma endregion
...
#pragma region Fields
	...
	PopVector<Color> mColors;
	Padding mMousePadding;
	bool mDoFinger;
	bool mWantsFocus;
	UIElement* mPrev;
	UIElement* mNext;
...
{
	UIElement* mBaseModalElement;
	UIElement* mPrevBaseModalElement;
	UIElement* mPrevFocusElement;
	PopFlags mPrevBelowModalFlags;
};